...
extern const string imuTopic = "/imu/data_none";
...
//extern const float ang_bottom = 13.4;
//extern const int groundScanInd = 57;
...
extern const float ang_res_y = 33.2/float(N_SCAN-1);
extern const float ang_bottom = 16.6+0.1;
extern const int groundScanInd = 17;
...
extern const float nearestFeatureSearchSqDist = 50;
...
extern const float historyKeyframeFitnessScore = 0.3; // default 0.3; the smaller the better alignment

extern const float globalMapVisualizationSearchRadius = 1000.0; // key frames with in n meters will be visualized
